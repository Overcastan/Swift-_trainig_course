...
let nounArray = ["puppy", "laptop", "ocean","app", "cow", "skateboard", "developer", "coffee", "moon", "Swift", "Xcode"]

let index1 = Int(arc4random() % 11)
let index2 = Int(arc4random() % 11)
...
let yourSentence = "I installed a silly \(nounArray[10]) to do my \(nounArray[9]) excercises."
let index3 = Int(arc4random() % 11)
let index4 = Int(arc4random() % 11)
let yourSillySentence = "Biba is \(nounArray[index3]), and Boba is \(nounArray[index4])"
//: ### Exercise 2
...
let res = lottaLikes.replacing("like, ", with: "")
//: ### Exercise 7
// Example
...
var res1 = "$" + String(numOfPennies / 100) + "." + String(numOfPennies % 100)
//desired output = "$5.67"
//: # Let or Var?
import UIKit
import Foundation
